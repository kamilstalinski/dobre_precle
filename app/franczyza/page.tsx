  ...
  return (
    <section>
      ...
      <div className='container mx-auto px-[5%] my-[70px] md:my-[30px]'>
        <h2 className='text-text-color text-[40px] md:text-[30px] sm:text-[20px] font-bold -mb-4'>
          Chcesz podjąć z nami współpracę i otworzyć lokal we franczyzie?
        </h2>
        <h3 className='text-[30px] md:text-[24px] sm:text-[14px] mt-10 '>
      ...
      <div className='bg-text-color w-full h-[20rem] md:h-[15rem] sm:h-[10rem] flex items-center justify-center'>
        <div className='relative bg-green-300 w-[19%] md:w-[25%] max-w-[230px] h-full'>
          <div className='absolute top-[8%] w-[90px] md:w-[60px] h-[200px] md:h-[60px]'>
            <Image src='/marker.svg' alt='marker' fill />
          </div>
          <div className='absolute top-[0%] right-0 w-[70px] md:w-[60px] h-[200px] md:h-[60px]'>
            <Image src='/marker.svg' alt='marker' fill />
          </div>
          <div className='absolute top-[35%] left-[35%] w-[80px] md:w-[60px] h-[200px] md:h-[60px]'>
            <Image src='/marker.svg' alt='marker' fill />
          </div>
        </div>
        ...
        <div className='relative bg-green-300 w-[19%] md:w-[25%] max-w-[230px] h-full'>
          <div className='absolute top-[35%] left-[35%] w-[80px] md:w-[60px] h-[200px] md:h-[60px] sm:hidden'>
            <Image src='/marker.svg' alt='marker' fill />
          </div>
          <div className='absolute top-[8%] right-0 w-[65px] md:w-[60px] h-[200px] md:h-[60px] sm:hidden'>
            <Image src='/marker.svg' alt='marker' fill />
          </div>
          <div className='absolute top-[0%] w-[80px] md:w-[60px] h-[200px] md:h-[60px]'>
            <Image src='/marker.svg' alt='marker' fill />
          </div>
        </div>
      </div>
